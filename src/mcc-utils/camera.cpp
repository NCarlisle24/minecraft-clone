...
void Camera::setDirectionDirect(const glm::vec3 &newDirection, const glm::vec3 &newHorizontalDirection, const glm::vec3 &newDirectionAngles, const AngleType &angleType) {
